            ...
            <div class="row">
                ...
                <div class="col-lg-5 me-auto pt-5">
                    <div class="event-form pt-5">
                        <form action="{{ url('save_event') }}" method="POST" class="event_form">
                            @csrf
                            <div class="form-1">
                                ...
                                <input type="text" name="name" id="name" value="" class="form-control mt-5" placeholder="Team Name">
                            ...
                            <div class="form-2" style="display: none;">
                                ...
                                <div class="form-group after v-hide">
                                ...
                                <div class="form-group after v-hide">
                                    ...
                                    <input type="text" name="org_name" value="" class="form-control" placeholder="School or Organization name">
                                </div>
                                <input type="number" name="zip" id="zip" value="" class="form-control mt-5 w-25 v-hide" placeholder="Zip Code">
                                <button type="button" class="blue-btn mt-4 v-hide">Next: Fundraiser details<i class="fas fa-chevron-right ms-2"></i></button>
                            </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-3 ps-0 mb-3">
                                        <div class="input-checkbox">
                                            <input type="radio" value="just-me" name="members" id="input-checkbox-1">
                                            <label class="input-checkbox-label" for="input-checkbox-1">Just me</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 ps-0 mb-3">
                                        <div class="input-checkbox">
...
<script>
    ...
    // $(document).ready(function(){
        ...
        // const cate_id =  $('#cate_type').val();
             ...
             $.ajax({
                url: '{{ url('get_org_type') }}', // Change this to your route URL
                method: 'POST',
                data: {id:id},
