...
<head>
    <title>:: HexaBit Dark :: Login</title>
    <meta charset="utf-8">
            ...
            <div class="row clearfix">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="javascript:void(0);"><img src="../assets/images/icon-light.svg"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-auth-small" action="{{ url('admin/login_check') }}" method="POST">
                                @csrf
