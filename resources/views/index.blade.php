...
<section class="hero-sec">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('front_assets/images/home.png') }}" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-5 mb-5">
            <div class="col-lg-3">
                <div class="feature-box">
                    <img src="{{ asset('front_assets/images/feature-1.png')}}')}}" alt="">
                    <h3>100% VIRTUAL</h3>
            ...
            <div class="col-lg-3">
                <div class="feature-box">
                    <img src="{{ asset('front_assets//images/feature-2.png')}}" alt="">
            ...
            <div class="col-lg-3">
                <div class="feature-box">
                    <img src="{{ asset('front_assets//images/feature-3.png')}}" alt="">
            ...
            <div class="col-lg-3">
                <div class="feature-box">
                    <img src="{{ asset('front_assets//images/feature-4.png')}}" alt="">
    ...
    <div class="container">
        <div class="row align-items-center mb-5">
            ...
            <div class="col-lg-6 text-lg-end">
                <img src="{{ asset('front_assets//images/store.png')}}" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row mb-5">
            <div class="col-12 mb-5">
                <div class="owl-carousel" id="charity-carousel">
                    ...
                    <div class="item">
                        <div class="box">
                            <img src="{{ asset('front_assets//images/charity-4.jpg.png')}}" alt="">
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="box">
                            <img src="{{ asset('front_assets//images/charity-5.jpg.png')}}" alt="">
                            <div class="text">
                                <h2>in South Africa</h2>
                    ...
                    <div class="item">
                        <div class="box">
                            <img src="{{ asset('front_assets//images/charity-6.jpg.png')}}" alt="">
                            <div class="text">
                                <h2>in South Africa</h2>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                        <div class="row g-0 align-items-center">
                            ...
                            <div class="col-lg-6">
                                <img src="{{ asset('front_assets//images/events.png')}}" alt="" class="img-fluid">
                            </div>
        ...
        <div class="row mb-5 g-0">
            ...
            <div class="col-lg-5">
                <div class="owl-carousel" id="shop-carousel">
                    ...
                    <div class="items">
                        <div class="box">
                            <img src="{{ asset('front_assets//images/image 8.png')}}" alt="">
                    ...
                    <div class="items">
                        <div class="box">
                            <img src="{{ asset('front_assets//images/image 9.png')}}" alt="">
                            <div class="d-flex justify-content-between align-items-end">
                                <div class="text">
                                    <h6 class="price">$70.00 <span>$120.00</span></h6>
                                    <h5>Lorem ipsum</h5>
...
<section class="gift-card">
    <div class="container">
        <div class="row mb-5 align-items-center">
            <div class="col-lg-6">
                ...
                <form method="POST" action="" class="gift-form">
                    <div class="form-group w-75">
                        <div class="icon"><img src="{{ asset('front_assets//images/SVG.png')}}" alt="" class="img-fluid"></div>
            ...
            <div class="col-lg-6">
                <img src="{{ asset('front_assets//images/Section-3.png')}}" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row mb-5 justify-content-center">
            <div class="col-lg-2 col-md-6 mb-lg-0 mb-5">
                <img src="{{ asset('front_assets//images/client-1.png')}}" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-6 mb-lg-0 mb-5">
                <img src="{{ asset('front_assets//images/client-2.png')}}" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-6 mb-lg-0 mb-5">
                <img src="{{ asset('front_assets//images/client-3.png')}}" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-6 mb-lg-0 mb-5">
                <img src="{{ asset('front_assets//images/client-4.png')}}" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-6 mb-lg-0 mb-5">
                <img src="{{ asset('front_assets//images/client-5.png')}}" alt="" class="img-fluid">
